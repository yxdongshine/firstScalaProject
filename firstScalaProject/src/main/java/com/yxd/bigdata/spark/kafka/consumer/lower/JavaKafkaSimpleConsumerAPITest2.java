 ...
 */
public class JavaKafkaSimpleConsumerAPITest2 {
    public static void main(String[] args) {
        JavaKafkaSimpleConsumerAPI example = new JavaKafkaSimpleConsumerAPI(2);
        long maxReads = 20;
        // 获取topic名称为beifeng的，分区id为0的分区中的数据
        String topic = "yxdkafka0";
        int partitionID = 0;

        KafkaTopicPartitionInfo topicPartitionInfo2 = new KafkaTopicPartitionInfo(topic, 2);
        ...
        for(int i=0 ;i < Long.MAX_VALUE;i++){
            try {
                ...
                example.run(maxReads, topicPartitionInfo2, seeds);
